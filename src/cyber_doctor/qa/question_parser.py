...
from cyber_doctor.qa.prompt_templates import get_question_parser_prompt
from cyber_doctor.qa.purpose_type import purpose_map
...
def is_mngs_judgement_question(question: str) -> bool:
    ...
    if any(marker in question for marker in direct_markers):
        return True
    try:
        from cyber_doctor.model.rag.structured_retriever import find_pathogen
